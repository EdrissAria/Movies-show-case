const styles = {
  whiteText: "text-gray-300",
  blackText: "text-gray-400",
  ...
  fullImg: "w-full h-full lg:p-36 md:p-12 sm:p-6  object-cover",
  sectionImg: "w-full h-full minmd:w-11/12 minmd:h-11/12 p-12 object-contain",
